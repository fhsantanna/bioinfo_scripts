...
#Fasta files from a specific gene but from different lineages can be joined for subsequent alignment. Ex: cat *rpoB_ren.fas > rpoB_all.fasta; muscle -in rpoB_all.fasta -out rpoB_all_aln.fasta
