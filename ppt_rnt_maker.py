...
#Cria arquivos ptt e rnt a partir de um arquivo genbank. Util para a utilizacao do EDGE-pro (Estimated Degree of Gene Expression for Prokaryotes).
#Acrescentar futuramente a opcao de digitar o nome dos arquivos na linha de comando.
